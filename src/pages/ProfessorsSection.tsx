    ...
    <div className="flex items-center justify-center min-h-screen px-4">
      <div className="flex flex-col md:flex-row rounded-2xl overflow-hidden max-w-7xl w-full">
        ...
        <div className="py-16 px-4 max-w-6xl mx-auto">
          {/* AnimatePresence ensures animations play fully on unmount */}
          ...
          {/* AnimatePresence for the entire container */}
          <AnimatePresence mode="wait">
            <motion.div
            ...
            >
              {professors.map((professor, index) => (
                <motion.div
                  key={`professor-${index}-${animationKey}`}
                ...
                >
                  ...
                  <div className="text-[#000] text-center font-bold mb-6 text-xl">
