const About = () => {
  return (
    <div className="relative">
      ...
      {/* Foreground Content */}
      <div className="relative z-10 w-full flex justify-center items-start p-8 min-h-[750px] bg-[url('/BG-Pattern.png')] bg-cover bg-center bg-no-repeat bg-fixed">
        <div className="w-full max-w-6xl rounded-3xl flex flex-col md:flex-row gap-4 md:gap-6 p-3 md:p-5">
          ...
          <div className="flex-1 flex flex-col justify-center gap-4">
            <p className="text-xl text-[#B68842] font-bold font-serif">
